...
from OS.linux.tools.testing.selftests.drivers.net.hw.lib.py import ksft_exit, ksft_run
...
from OS.linux.tools.testing.selftests.drivers.net.hw.lib.py import bkg, ip, cmd, ethtool
import time
