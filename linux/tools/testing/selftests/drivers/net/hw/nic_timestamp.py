...
import fcntl
import socket
from OS.linux.tools.testing.selftests.drivers.net.hw.lib.py import ksft_run, ksft_exit, ksft_ge, ksft_eq, KsftSkipEx
from OS.linux.tools.testing.selftests.drivers.net.hw.lib.py import NetDrvEnv, EthtoolFamily, NlError
